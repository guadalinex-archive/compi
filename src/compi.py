...
if __name__ == "__main__":
    ...
    if pid: # proceso padre
        ...
        if s:
            ...
            if not config.player.pymedia_installed:
                aviso(_("Se ha detectado que no están instaladas las librerias Pymedia para reproducir archivos de audio.\nPor favor, descargue e instale el paquete de la siguiente dirección para soportar dichos ficheros:"),
